...
const CommentField = ({ action, index = undefined, replyingTo = undefined, setReplying }) => {
  ...
  let { blog: { _id, author: { _id: blog_author }, activity, comments, comments: { results: commentsArr }, activity: { total_comments, total_parent_comments } }, blog, setBlog, setTotalParentCommentsLoaded } = useContext(BlogContext)
