    ...
    <AnimationWrapper keyValue={type}>
      <section className="h-cover flex items-center justify-center">
        ...
        <form ref={authForm} action="" className="w-[80%] group max-w-[400px]">
          ...
          <div className="p-2 sm:px-4 rounded-md w-auto bg-red/75 text-center tracking-tight sm:tracking-wider font-extralight text-gray-50 mt-5 mx-4 sm:mx-10">
            {"Google Auth is not available on mobiles/tablets. "}
            <Link to={"/help"} className="underline">
              Need Help?
            </Link>
          </div>
          <div className="max-md:hidden w-full items-center flex gap-2 my-10 opacity-10 uppercase text-black font-bold">
            <hr className="w-1/2 border-black" />
            or
            <hr className="w-1/2 border-black" />
          </div>
          <button
            className="max-md:hidden btn-dark flex items-center gap-4 w-auto sm:w-[90%] justify-center center"
